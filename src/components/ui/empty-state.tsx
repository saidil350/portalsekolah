          ...
          {actions.map((action, index) => (
            <button
              ...
              className={cn(
                ...
                action.variant === 'secondary' && "bg-white border border-slate-200 text-foreground hover:bg-surface-bg-alt",
                action.variant === 'ghost' && "bg-transparent text-foreground hover:bg-surface-bg-alt",
