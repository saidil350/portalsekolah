    ...
    <main className="flex-1 flex flex-col h-full bg-[#FAFAFA]">
      ...
      <header className="bg-card border-b border-border px-8 py-6 shrink-0">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground">Jadwal Kelas Saya</h1>
        ...
        <div className="flex items-center gap-4">
          <div>
            <label className="block text-xs font-medium text-muted-foreground mb-1">Tahun Akademik</label>
            <select
              value={academicYear}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {classes.map((classInfo) => (
              <div
                ...
                className="bg-card rounded-xl border border-border shadow-sm hover:shadow-md hover:border-purple-300 transition-all cursor-pointer group"
              >
                {/* Header */}
                <div className="p-6 border-b border-border/60">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">{classInfo.class_code}</p>
                    </div>
                    <div className="w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center">
